...
const StyledJira = styled(motion.div)`
        ...
        <StyledJira className="jira">
            ...
            <div className="jira__navbar">
                ...
                <motion.div className="jira__navbar--section" id="jira__navbar--planning">
                    ...
                    <div className="jira__navbar--highlight">
                        ...
                        <div className="jira__navbar--item">
                            <div><svg width="24" height="24" viewBox="0 0 24 24" role="presentation"><path d="M6 2h10a3 3 0 010 6H6a3 3 0 110-6zm0 2a1 1 0 100 2h10a1 1 0 000-2H6zm4 5h8a3 3 0 010 6h-8a3 3 0 010-6zm0 2a1 1 0 000 2h8a1 1 0 000-2h-8zm-4 5h6a3 3 0 010 6H6a3 3 0 010-6zm0 2a1 1 0 000 2h6a1 1 0 000-2H6z" fill="currentColor" fill-rule="evenodd"></path></svg></div>
                            <p>Roadmap</p>
                        </div>
                        <div className="jira__navbar--item">
                ...
                <motion.div className="jira__navbar--section" id="jira__navbar--development">
                    ...
                    <div>
                        <div className="jira__navbar--item">
                            <div><svg width="24" height="24" viewBox="0 0 24 24" role="presentation"><path d="M14.155 4.055a1 1 0 00-1.271.62l-4.83 14.046a1 1 0 001.891.65l4.83-14.045a1 1 0 00-.62-1.271m-6.138 8.21l-2.58-2.501L8.236 7.05a.999.999 0 10-1.392-1.436l-3.54 3.432a1 1 0 000 1.436l3.32 3.219a1 1 0 101.393-1.436m12.219 1.568l-3.32-3.22a.999.999 0 10-1.393 1.437l2.58 2.5-2.799 2.715a.999.999 0 101.392 1.436l3.54-3.432a1 1 0 000-1.436" fill="currentColor" fill-rule="evenodd"></path></svg></div>
                            <p>Code</p>
                        </div>
                        <div className="jira__navbar--item">
                            <div><svg width="24" height="24" viewBox="0 0 24 24" role="presentation"><g fill="currentColor" fill-rule="evenodd"><path d="M6 12h8v-2H6v2zM4 8.99C4 8.445 4.456 8 5.002 8h9.996C15.55 8 16 8.451 16 8.99V14H4V8.99z" fill-rule="nonzero"></path><path d="M6 7.005C6 5.898 6.898 5 7.998 5h2.004C11.106 5 12 5.894 12 7.005V10H6V7.005zm4 0V7H7.999c.005 0 .002.003.002.005V8h2v-.995z"></path><path d="M4.5 17h13.994l1.002-3H4.14l.36 3zm-2.495-4.012A.862.862 0 012.883 12h18.393c.55 0 .857.417.681.944l-1.707 5.112c-.174.521-.758.944-1.315.944H3.725a1.149 1.149 0 01-1.118-.988l-.602-5.024z" fill-rule="nonzero"></path></g></svg></div>
                            <p>Releases</p>
                        </div>
                    </div>
                </motion.div>
                <motion.div className="jira__navbar--section" id="jira__navbar--operations">
                    ...
                    <div>
                        <div className="jira__navbar--item">
                            <div><svg width="24" height="24" viewBox="0 0 24 24" role="presentation"><g fill="currentColor" fill-rule="evenodd"><rect x="8" y="6" width="8" height="2" rx="1"></rect><rect x="8" y="9" width="8" height="2" rx="1"></rect><rect x="8" y="12" width="4" height="2" rx="1"></rect><path d="M7 4v16h10V4H7zm-2-.01C5 2.892 5.897 2 7.006 2h9.988C18.102 2 19 2.898 19 3.99v16.02c0 1.099-.897 1.99-2.006 1.99H7.006A2.003 2.003 0 015 20.01V3.99z" fill-rule="nonzero"></path></g></svg></div>
                            <p>Project pages</p>
                        </div>
                    </div>
                    <div>
